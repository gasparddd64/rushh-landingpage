...
const STEPS: StepData[] = [
  ...
  { icon: true, title: "On lance !", kicker: "Rushh décroche", desc: "Dès la mise en ligne, chaque appel est pris, chaque prospect qualifié, chaque fiche transmise.", cta: "Réserver ma démo" },
];
